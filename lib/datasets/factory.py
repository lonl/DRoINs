...
name = 'VEDAI_1024_for_HPC'
data_path = "/home/a409/users/liqing/diff_pair/train/"
__sets[name] = (lambda name = name, data_path=data_path:car(name,data_path))
